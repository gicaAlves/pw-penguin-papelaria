...
<body>
  <?php 
    ...
    include 'conexao.php'; 
    $consulta = $con->query(' select cod_prod, img_prod, nome_prod, preco_prod, quant_prod, nov_prod from vw_cat_prod where nov_prod = true; ');
  ?>
...
<!--SÓ NO NADA SE CRIA O NEGÓCIO É COPIAR, PAGINA DE LANÇAMENTOS ESTOUROUUUUUU-->
